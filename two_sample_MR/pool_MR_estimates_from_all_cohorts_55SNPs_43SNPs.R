...
ukb$outcome<-c("loss","stillbirth","miscarriage","gdm","hdp","pd","pt","lbw","hbw","bw")
#other<-other[ which(other$method=="Inverse variance weighted"),]
...
poolresults <- matrix(, ncol=3, nrow=10)
